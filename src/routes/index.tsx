...
const heroWords = ["sell", "convert", "grow", "perform"];
        ...
        <section className="relative isolate overflow-hidden px-6 pb-28 pt-40">
          ...
          <div className="relative mx-auto max-w-7xl">
            <div className="max-w-3xl">
              <h1 className="font-display flex flex-wrap items-baseline gap-x-3 gap-y-1 text-5xl font-bold leading-[0.95] tracking-tight md:gap-x-4 md:text-7xl">
